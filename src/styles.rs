...
pub fn btn_style_light_square(theme: &iced::Theme, _status: iced::widget::button::Status) -> button::Style {
	...
	button::Style { background: Some(iced::Background::Color(palette.primary)), text_color: rgb!(45., 45., 45.), ..Default::default() }
}

pub fn btn_style_dark_square(theme: &iced::Theme, _status: iced::widget::button::Status) -> button::Style {
	let palette = theme.palette();
	button::Style { background: Some(iced::Background::Color(palette.success)), text_color: rgb!(45., 45., 45.), ..Default::default() }
}

pub fn btn_style_selected_light_square(_theme: &iced::Theme, _status: iced::widget::button::Status) -> button::Style {
	button::Style { background: Some(iced::Background::Color(SELECTED_LIGHT_SQUARE)), text_color: rgb!(45., 45., 45.), ..Default::default() }
}

pub fn btn_style_selected_dark_square(_theme: &iced::Theme, _status: iced::widget::button::Status) -> button::Style {
	button::Style { background: Some(iced::Background::Color(SELECTED_DARK_SQUARE)), text_color: rgb!(45., 45., 45.), ..Default::default() }
}
...
pub fn btn_style_paper(_theme: &iced::Theme, _status: iced::widget::button::Status) -> button::Style {
	button::Style {
		...
		border: Border { color: iced::Color::BLACK, width: 0., radius: 0.0.into() },
		..Default::default()
	}
}
...
pub fn container_style_light_square(theme: &iced::Theme) -> container::Style {
	let palette = theme.palette();
	container::Style { background: Some(iced::Background::Color(palette.primary)), text_color: Some(rgb!(45., 45., 45.)), ..Default::default() }
}

pub fn container_style_dark_square(theme: &iced::Theme) -> container::Style {
	let palette = theme.palette();
	container::Style { background: Some(iced::Background::Color(palette.success)), text_color: Some(rgb!(45., 45., 45.)), ..Default::default() }
}
...
pub fn pick_list_style(theme: &iced::Theme, _status: iced::widget::pick_list::Status) -> pick_list::Style {
	...
	pick_list::Style {
		...
		border: Border { color: palette.success.strong.color, width: 1., radius: 0.3.into() },
	}
}
